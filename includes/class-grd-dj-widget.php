...
class GRDR_Grd_Dj_Widget extends WP_Widget {
	 ...
	 * @since  NEXT
	 */
	protected $widget_slug = 'dj-rotator-for-wordpress-grd-dj-widget';
	 ...
	 * @since  NEXT
	 */
	protected static $shortcode = 'dj-rotator-for-wordpress-grd-dj-widget';
	...
	public function __construct() {
		...
		$this->widget_name          = esc_html__( 'DJ Rotator for WordPress Grd Dj Widget', 'dj-rotator-for-wordpress' );
		$this->default_widget_title = esc_html__( 'DJ Rotator for WordPress Grd Dj Widget', 'dj-rotator-for-wordpress' );
		...
		parent::__construct(
			...
			array(
				...
				'description' => esc_html__( 'A widget boilerplate description.', 'dj-rotator-for-wordpress' ),
			)
		);
	...
	public function form( $instance ) {
		...
		?>
		<p><label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Title:', 'dj-rotator-for-wordpress' ); ?></label>
		...
		<p><label for="<?php echo esc_attr( $this->get_field_id( 'text' ) ); ?>"><?php esc_html_e( 'Text:', 'dj-rotator-for-wordpress' ); ?></label>
		...
		<p class="description"><?php esc_html_e( 'Basic HTML tags are allowed.', 'dj-rotator-for-wordpress' ); ?></p>
		<?php
	}
}
 ...
 * @return void
 */
function register_dj_rotator_for_wordpress_grd_dj_widget() {
	register_widget( 'GRDR_Grd_Dj_Widget' );
}
add_action( 'widgets_init', 'register_dj_rotator_for_wordpress_grd_dj_widget' );
